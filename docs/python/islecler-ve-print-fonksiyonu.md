...
Karşılaştırma işleçleri işlenenler arasında bir karşılaştırma işlemi yapmamızı sağlar, 3
...
print fonksiyonu'nun amacı ekrana yazı yazdırmaktır, fonksiyonlara kısa giriş dersini

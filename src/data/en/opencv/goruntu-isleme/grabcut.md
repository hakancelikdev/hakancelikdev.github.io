...
excerpt: "Learn to use GrabCut algorithm to extract foreground in images. We cover cv2.grabCut() with both rectangle and mask initialization modes."
category: OpenCV
...
![GrabCut output](/images/posts/opencv/grabcut_output1.jpg)
...
![GrabCut scheme](/images/posts/opencv/grabcut_scheme.jpg)
...
![GrabCut rectangle mode](/images/posts/opencv/grabcut_rect.jpg)
...
![GrabCut mask mode](/images/posts/opencv/grabcut_mask.jpg)
...
1. OpenCV samples contain a sample grabcut.py which is an interactive tool using grabcut. Check it. Also watch this [youtube video](http://www.youtube.com/watch?v=kAwxLTDDAwU) on how to use it.
2. Here, you can make this into an interactive sample with drawing rectangle and strokes with mouse, create trackbar to adjust stroke width etc.

---

**Source:** [OpenCV Python Tutorials — Original Documentation](https://github.com/opencv/opencv/blob/4.x/doc/py_tutorials/py_imgproc/py_grabcut/py_grabcut.markdown)

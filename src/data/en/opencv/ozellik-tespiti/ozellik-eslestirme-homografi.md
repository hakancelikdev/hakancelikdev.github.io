...
excerpt: "Learn to combine feature matching and findHomography from the calib3d module to find known objects in complex images. We cover RANSAC-based robust perspective transform estimation."
category: OpenCV
...
We have seen that there can be some possible errors while matching which may affect the result. To solve this problem, algorithm uses RANSAC or LEAST_MEDIAN. **cv.findHomography()** returns a mask which specifies the inlier and outlier points.
...
![Homography find object](/images/posts/opencv/homography_findobj.jpg)

---

**Source:** [OpenCV Python Tutorials — Original Documentation](https://github.com/opencv/opencv/blob/4.x/doc/py_tutorials/py_feature2d/py_feature_homography/py_feature_homography.markdown)
